        ...
        <div class="modal-content">
          ...
          <div class="modal-body row">
            ...
            <div class="mb-3 row g-0">
              ...
              <label for="avatar-group" class="row g-0">
                <div class="bg-secondary row g-0" style="height: 300px">
                  <img id="avatar" class="w-100 h-100" type="button"/>
                </div>
              </label>
            </div>
            <input
            ...
            <div class="mb-3">
              ...
              <div class="form-control row">
                <label
                  class="col-3 border"
                  id="trade"
                  @click="setBonus('trade')"
                  >trade</label
                >
                <label
                  class="col-3 border"
                  id="knowledge"
                  @click="setBonus('knowledge')"
                  >knowledge</label
                >
                <label
                  class="col-3 border"
                  id="entertain"
                  @click="setBonus('entertain')"
                  >entertain</label
                >
                <label
                  class="col-3 border"
                  id="sociable"
                  @click="setBonus('sociable')"
                  >sociable</label
                >
                <label class="col-3 border" id="help" @click="setBonus('help')"
                  >help new</label
                >
                <label
                  class="col-3 border"
                  id="singing"
                  @click="setBonus('singing')"
                  >singing</label
                >
              </div>
            </div>
